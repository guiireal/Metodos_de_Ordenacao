...
/**
 * JANELA DO MÉTODO INSERÇÃO VIA TECLADO (LÓGICA)
 * 
 * @author Guilherme
 */
public class JanelaInsercaoTeclado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("MÉTODO INSERÇÃO VIA TECLADO");
        ...
        lblCodigo.setText("<html>\n<body>\nfor (int i = 1; i < tamanho; i++) { <br/>\n&nbsp &nbsp aux = vetor[i]; <br/>\n&nbsp &nbsp j = i; <br/>\n&nbsp &nbsp while ((j > 0) && (vetor[j - 1]) > aux) { <br/>\n&nbsp &nbsp &nbsp &nbsp vetor[j] = vetor[j - 1]; <br/>\n&nbsp &nbsp&nbsp &nbsp  j--; <br/>\n&nbsp &nbsp } <br/>\n&nbsp &nbsp vetor[j] = aux; <br/>\n}\n<body>\n<html>");
    ...
    private void executarSolucao(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_executarSolucao
        ...
        this.ordenar.metodoInsercao(this.getVetor(), this.getTamanho(), "crescente");
        for (int i = 0; i < this.getVetor().length; i++) {
            crescente = crescente + Integer.toString(this.getVetor()[i]) + "  ";
        }
        this.ordenar.metodoInsercao(this.getVetor(), this.getTamanho(), "decrescente");
        for (int i = 0; i < this.getVetor().length; i++) {
