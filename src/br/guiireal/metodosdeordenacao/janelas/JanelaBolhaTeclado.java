...
/**
 * JANELA DO MÉTODO BOLHA VIA TECLADO (LÓGICA)
 * 
 * @author Guilherme
 */
public class JanelaBolhaTeclado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("MÉTODO BOLHA VIA TECLADO");
        ...
        lblCodigo.setText("<html>\n<body>\n        for (int i = 0; i < tamanho-1; i++) {  <br/>\n        &nbsp &nbsp for (int j = 0; j < tamanho-1; j++) { <br/>   \n        &nbsp &nbsp &nbsp &nbsp if (vetor[j] > vetor[j+1]) { <br/>     \n        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp aux = vetor[j]; <br/>      \n        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp vetor[j] = vetor[j+1]; <br/>      \n        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp vetor[j+1] = aux; <br/>    \n        &nbsp &nbsp &nbsp &nbsp  } <br/>\n        &nbsp &nbsp } <br/>   \n        }\n</body>\n</html>");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jpnCodigo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lblInfo2, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(spnDefinirTamVetor))
                            .addComponent(btnIniciarAlgoritmo, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    private void executarSolucao(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_executarSolucao
        ...
        this.ordenar.metodoBolha(this.getVetor(), this.getTamanho(), "crescente");
        for (int i = 0; i < this.getVetor().length; i++) {
            crescente = crescente + Integer.toString(this.getVetor()[i]) + "  ";
        }
        this.ordenar.metodoBolha(this.getVetor(), this.getTamanho(), "decrescente");
        for (int i = 0; i < this.getVetor().length; i++) {
