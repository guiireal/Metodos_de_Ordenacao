...
/**
 * JANELA DO MÉTODO SELEÇÃO
 * 
 * @author Guilherme
 */
public class JanelaSelecao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("MÉTODO SELEÇÃO");
        ...
        lblSubTitulo.setText("Por onde deseja realizar o método seleção ?");
    ...
    private void iniciarMetodoTeclado(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniciarMetodoTeclado
        JanelaSelecaoTeclado jst = new JanelaSelecaoTeclado();
        jst.setVisible(true);
    ...
    private void iniciarMetodoArquivo(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniciarMetodoArquivo
        JanelaSelecaoArquivo jsa = new JanelaSelecaoArquivo();
        jsa.setVisible(true);
