...
/**
 * JANELA DO MÉTODO BOLHA
 * 
 * @author Guilherme
 */
public class JanelaBolha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("MÉTODO BOLHA");
        ...
        lblSubTitulo.setText("Por onde deseja realizar o método bolha ?");
    ...
    private void iniciarMetodoTeclado(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniciarMetodoTeclado
        JanelaBolhaTeclado jbt = new JanelaBolhaTeclado();
        jbt.setVisible(true);
    }//GEN-LAST:event_iniciarMetodoTeclado

    private void btnArquivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnArquivoActionPerformed
        JanelaBolhaArquivo jba = new JanelaBolhaArquivo();
        jba.setVisible(true);
